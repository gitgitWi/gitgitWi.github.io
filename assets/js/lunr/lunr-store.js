var store = [{
        ...
        "title": "1강 - 알고리즘 문제해결",
        "excerpt":"1강 - 알고리즘 문제해결 (problem solving) ClassName: 기초 알고리즘과 파이썬 코딩 Created: Mar 02, 2020 10:42 PM 제공처: Tacademy https://www.youtube.com/playlist?list=PL9mhQYIlKEhfg0aLdaO04wYUovLMXY4DU 알고리즘 문제해결 problem solving이란 무엇?? 프로그래밍 언어를 통해 시간제한, 메모리 제한에서 주어진 문제 해결 problem solving을 하는 이유 구현 능력 - 본인이 생각하고 있는 내용을 코드로 옮길 수 있는가? 연습을...","categories": ["fundamentals","algorithms"],
        "tags": ["algorithms","LectureNotes","SKTacademy"],
        "url": "http://localhost:4000/fundamentals/algorithms/algo1/",
        "teaser": null
      },{
        ...
        "excerpt":"4강 - 자료구조와 알고리즘 I - sort (select/bubble/quick/merge/radix) ClassName: 기초 알고리즘과 파이썬 코딩 Created: Mar 03, 2020 3:33 PM 제공처: Tacademy 파이썬에서는 sort / sorted 함수를 통해 간단하게 정렬 가능 다만 정렬하는 원리에 대해서는 반드시 알아야 함 selection sort O ( N^2 ) bubble sort O ( N^2 ) quick...","categories": ["fundamentals","algorithms"],
        "tags": ["algorithms","LectureNotes","SKTacademy"],
        "url": "http://localhost:4000/fundamentals/algorithms/algo4/",
        "teaser": null
      },{
        "title": "5강 - 자료구조와 알고리즘 II - Stack/Queue/Deque",
        "excerpt":"5강 - 자료구조와 알고리즘 II - stack/queue/deque ClassName: 기초 알고리즘과 파이썬 코딩 Created: Mar 03, 2020 3:54 PM 제공처: Tacademy 자료구조 : 자료를 저장하는 방법론, 규칙 효율성 : 대부분의 자료구조마다 특화된 용도가 있음 추상화 : 언어에 국한되지 않고 쓸 수 있는 것 재사용성 : 라이브러리 제공 ; python에서는 Collection STACK...","categories": ["fundamentals","algorithms"],
        "tags": ["algorithms","LectureNotes","SKTacademy"],
        "url": "http://localhost:4000/fundamentals/algorithms/algo5/",
        "teaser": null
      },{
        "title": "6강 - 자료구조와 알고리즘 III - graph/tree/heap/BST",
        "excerpt":"6강 - 자료구조와 알고리즘 III - graph/tree/heap/BST ClassName: 기초 알고리즘과 파이썬 코딩 Created: Mar 03, 2020 4:17 PM 제공처: Tacademy Graph 노드 Node와 간선 Edge로 구성 들어오는 간선 수 indegree 나가는 간선 수 outdegree 저장방법 : 인접 행렬 방향성, 가중치 추가 다만 행렬에 0이 많은 그래프, sparse한 그래프라면 인접리스트 사용...","categories": ["fundamentals","algorithms"],
        "tags": ["algorithms","LectureNotes","SKTacademy"],
        "url": "http://localhost:4000/fundamentals/algorithms/algo6/",
        "teaser": null
      },{
        "title": "7강 - 자료구조와 알고리즘 IV - DFS/BFS",
        "excerpt":"7강 - 자료구조와 알고리즘 IV - DFS/BFS ClassName: 기초 알고리즘과 파이썬 코딩 Created: Mar 03, 2020 4:46 PM 제공처: Tacademy DFS Depth First Search ; 깊이 우선 탐색 전수조사에서 주로 사용, Stack 방식과 유사, 컴퓨터 메모리 관리가 대부분 stack 방식 BFS Breadth First Search ; 너비 우선 탐색 Queue 방식과...","categories": ["fundamentals","algorithms"],
        "tags": ["algorithms","LectureNotes","SKTacademy"],
        ...
        "url": "http://localhost:4000/study/r/aidata/Lecture-0403-2-Visualization-Maps-&-Graphs/",
        "teaser": null
      },{
        ...
        "url": "http://localhost:4000/study/cloud/aws/docker/",
        "teaser": null
      },{
        "title": "왕초보도 따라하는 도커 기초 강의 by 재즐보프 youtube",
        "excerpt":"Docker basic by 재즐보프’s Youtube 왕초보도 따라하는 도커 기초 강의 lecture notes Install Apps in Docker in Terminal (base) JnWui-MacBook-Pro:~ WnJ$ sudo -i JnWui-MacBook-Pro:~ root# docker search tomcat9 # 검색 결과로 나온 tomcat9 관련 이미지 중 원하는 것을 찾아 # docker에서 8080 포트로 바로 실행 JnWui-MacBook-Pro:~ root# docker run -d...","categories": ["Study","Cloud","Docker"],
        "tags": ["Docker","LectureNotes","Oracle","MySQL"],
        "url": "http://localhost:4000/study/cloud/docker/docker-basic-01/",
        "teaser": null
      },{
        "title": "LN-Docker-동빈나's Docker 활용 1강~2강",
        "excerpt":"01 실습용 AWS EC2 인스턴스 생성 및 접속 AWS 서버 인스턴스 생성 Docker Machine 설치를 위한 객체 생성 서버 인스턴스 EC2 강의일 현재까지 AWS에서 가장 많이 쓰이고 있는 서버 AMI 선택 Amazon Machine Image Ubuntu Server 18.04 (LTS) 선택 인스턴스 유형 선택 t2 micro free-tier 에서 사용 가능한 유일한 type...","categories": ["Study","Cloud","AWS"],
        "tags": ["Docker","LectureNotes","AWS","동빈나"],
        "url": "http://localhost:4000/study/cloud/aws/ln-aws-0102/",
        "teaser": null
      },{
        "title": "LN-Docker-동빈나's Docker 활용 3강~4강",
        "excerpt":"03 AWS EC2에 도커(Docker) 설치 및 Dockerfile로 웹 서버 구동시키기 Docker 설치를 위한 준비 AWS에서 생성한 jupyter-notebook 접속 현재 메모리 상황 확인 /# df -h Filesystem Size Used Avail Use% Mounted on udev 481M 0 481M 0% /dev tmpfs 99M 752K 98M 1% /run /dev/xvda1 7.7G 1.7G 6.1G 22% /...","categories": ["Study","Cloud","AWS","Docker"],
        "tags": ["Docker","LectureNotes","AWS","동빈나","Apache Server"],
        "url": "http://localhost:4000/study/cloud/aws/docker/ln-aws-0304/",
        "teaser": null
      },{
        "title": "LN-Docker-동빈나's Docker 활용 5강~6강",
        "excerpt":"05 Docker로 MySQL 컨테이너 만들어 보기 작업 전 모든 container 제거 root@ip-172-31-45-116:/# docker rm -f `docker ps -a -q` 0037b1e5d4eb root@ip-172-31-45-116:/# docker ps -a CONTAINER ID IMAGE COMMAND CREATED STATUS PORTS NAMES MySQL5.6 설치 host 9876 port와 MySQL 3306 port 연결 root@ip-172-31-45-116:/# docker run -d -p 9876:3306 -e MYSQL_ROOT_PASSWORD=1234 mysql:5.6...","categories": ["Study","Cloud","AWS","Docker"],
        "tags": ["Docker","LectureNotes","AWS","동빈나","Apache Server","MySQL"],
        "url": "http://localhost:4000/study/cloud/aws/docker/ln-aws-0506/",
        "teaser": null
      },{
        "title": "LN-Docker-동빈나's Docker 활용 7강~9강",
        "excerpt":"07 AWS RDS를 이용한 데이터베이스 구축 Amazon RDS를 통한 DB 생성 한글 parameter 설정 parameter 생성 parameter 수정 ‘char’, ‘collation’ 검색 가능한 모든 encoding을 UTF8, UTF8_general_ci로 설정 DB 생성 MySQL 5.6 template &gt; Free-Tier ; 반드시 확인! Master User Name / PW ; 외부접속 위한 ID/PW 보안 그룹 일반적으로 가장...","categories": ["Study","Cloud","AWS","Docker"],
        "tags": ["Docker","동빈나","LectureNotes","AWS","AWS RDS","MySQL","GitHub","DockerHub"],
        "url": "http://localhost:4000/study/cloud/aws/docker/ln-aws-0709/",
        "teaser": null
      },{
        "title": "LN-Docker-동빈나's Docker 활용 10강~11강",
        "excerpt":"10 Jenkins를 이용해 Docker 프로젝트 빌드해보기 Jenkins를 활용한 Build 자동화 Docker in Docker 방식 Jenkins 설치 및 실행 Jenkins도 기본포트 == 8080 Jenkins 안에서 php가 구동되도록 root@ip-172-31-45-116:~/# docker pull jenkins/jenkins:lts LTS tag 붙이지 않고 설치할 경우 plugins 설치 시 ERROR jenkins의 repository가 변경되어서 그렇다고 함.. docker run -d -p 8080:8080...","categories": ["Study","Cloud","AWS","Docker"],
        "tags": ["Docker","동빈나","LectureNotes","AWS","Jenkins"],
        "url": "http://localhost:4000/study/cloud/aws/docker/ln-aws-10~11/",
        "teaser": null
      },{
        ...
        "excerpt":"date: Apr 24, 2020 6 ~ 9 PM 멘토분들 성함은 개인정보라 가렸습니다. 문제시 삭제하겠습니다. Section1. 前 MS 인사총괄 특강 Resume 수치화 중요 지원하고자 하는 position과 align된 skill 위주 약 200번의 interview 경험 interview 전 항상 모의 연습, 면접관 관점에서 면접 직후 반드시 면접 내용 정리 다국적 기업 면접시, 궁금한 점에...","categories": ["Career"],
        "tags": ["Mentoring","MS","AWS"],
        "url": "http://localhost:4000/career/Fri_CPTeamX%EC%98%81%EB%93%B1%ED%8F%AC%EA%B5%AC%EC%B2%AD/",
        "teaser": null
      }]
